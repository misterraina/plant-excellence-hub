        ...
        <div className="relative overflow-hidden bg-white rounded-lg shadow-sm py-8">
          ...
          <div 
            ...
            style={{
              ...
              width: `${partnerLogos.length * 200}px`
            }}
          >
            {/* First set of logos */}
            {partnerLogos.map((partner, index) => (
              <div key={`first-${index}`} className="flex items-center justify-center min-w-[200px] px-8">
                <img
                  src={partner.logo}
                  alt={partner.name}
                  className="h-16 w-auto object-contain min-h-[40px]"
            ...
            {partnerLogos.map((partner, index) => (
              <div key={`second-${index}`} className="flex items-center justify-center min-w-[200px] px-8">
                <img
                  src={partner.logo}
                  alt={partner.name}
                  className="h-16 w-auto object-contain min-h-[40px]"
